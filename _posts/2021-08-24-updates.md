...
you will find your old requests in the archive now.
As always, the archive is placed at the chat list,
however, is now also **easier accessible** directly from the menu (Android),
...
The **title bar** (Android/iOS) or a **little banner** (Desktop)
